...
final class AdbProtocol {
    ...
    static final class Message {
         ...
         *
         * @param channel InputStream object to read data from
         ...
         */
        @NonNull
        public static Message parse(@NonNull AdbChannel channel, int protocolVersion, int maxData) throws IOException {
            ByteBuffer header = ByteBuffer.allocate(ADB_HEADER_LENGTH).order(ByteOrder.LITTLE_ENDIAN);

            // Read header
            channel.readx(header.array(),ADB_HEADER_LENGTH);
            ...
            channel.readx(msg.payload,msg.dataLength);
        ...
        public byte[]  getHeader(){
            ByteBuffer  mMessageBuffer = ByteBuffer.allocate(com.cgutman.adblib.AdbProtocol.ADB_HEADER_LENGTH).order(ByteOrder.LITTLE_ENDIAN);
            mMessageBuffer.putInt(0, command);
            mMessageBuffer.putInt(4, arg0);
            mMessageBuffer.putInt(8, arg1);
            mMessageBuffer.putInt(12, (payload == null ? 0 : payload.length));
            mMessageBuffer.putInt(16, (payload == null ? 0 : checksum(payload)));
        ...
        public String toString() {
            ...
            return "Message{" +
                    ...
                    ", payload=" + (dataLength>0?new String(payload):"")+
                    '}';
        }
    }
